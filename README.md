...
Today I create with html, css and js file for Elit Cafe. I use here html, css and js tags. 
## ## RULES OF USE

> *STEP-1:* `https://github.com/AnarXan/ElitCafe.git` <br/>
> *STEP-2:*  enter the `ElitCafe` folder that appears <br/>
> *STEP-3:*  open the folder you are in in a text editor <br/>
> *STEP-4:*  run the  all the`index.html` files in the main folder <br/>
> *STEP-5:*  to download the project as `.zip`  [here](https://github.com/AnarXan/ElitCafe/archive/refs/heads/master.zip) click <br/>
